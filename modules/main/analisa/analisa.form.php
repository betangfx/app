    ...
    <div class="col-md-12">
        <div class="form-group row">
            <div class="col-sm-9">
                ...
                <div class="input-group">
                    <input type="hidden" class="form-control" id="submodul" name="submodul"
                        value="<?php echo $submodul;?>">
                </div>
                <div class="input-group">
            ...
            <div class="col-sm-8">
                <select id="RangkaianID" name="Rangkaian" class="form-control" required>
                    ...
                    <?php
							...
							?>
                    <option value="<?php echo $RangkaianID;?>"
                        <?php if ($DARangkaianID == $RangkaianID) { echo "selected='selected'";} ?>>
                        <?php echo $Rangkaian;?></option>
                    <?php 
							}
						?>
                </select>
            ...
            <div class="col-sm-8">
                <select id="StrukturID" name="Struktur" class="form-control" required>
                    ...
                    <?php
							...
							?>
                    <option value="<?php echo $StrukturID;?>"
                        <?php if ($DAStrukturID == $StrukturID) { echo "selected='selected'";} ?>>
                        <?php echo $Struktur;?></option>
                    <?php 
							}
						?>
                </select>
                ...
                <select id="TipeID" name="Tipe" class="form-control" required>
                    ...
                    <?php
							...
							while ($dtipe = mysqli_fetch_array($qtipe,MYSQLI_ASSOC)) {
								...
								$Tipe	=	$dtipe['Tipe'];
							?>
                    <option value="<?php echo $TipeID;?>"
                        <?php if ($DATipeID == $TipeID) { echo "selected='selected'";} ?>><?php echo $Tipe;?></option>
                    <?php 
							}
						?>
                </select>
                ...
                <select id="PolaID" name="Pola" class="form-control" required>
                    ...
                    <?php
							...
							while ($dpola = mysqli_fetch_array($qpola,MYSQLI_ASSOC)) {
								...
								$Pola	=	$dpola['Pola'];
							?>
                    <option value="<?php echo $PolaID;?>"
                        <?php if ($DAPolaID == $PolaID) { echo "selected='selected'";} ?>><?php echo $Pola;?></option>
                    <?php 
							}
						?>
                </select>
            ...
            <div class="col-sm-8">
                <select id="PosisiID" name="Posisi" class="form-control" required>
                    ...
                    <?php
							...
							?>
                    <option value="<?php echo $PosisiID;?>"
                        <?php if ($DAPosisiID == $PosisiID) { echo "selected='selected'";} ?>><?php echo $Posisi;?>
                    </option>
                    <?php 
							}
						?>
            ...
            <div class="col-sm-8">
                <select id="DerajatID" name="Derajat" class="form-control" required>
                    ...
                    <?php
							...
							?>
                    <option value="<?php echo $DerajatID;?>"
                        <?php if ($DADerajatID == $DerajatID) { echo "selected='selected'";} ?>><?php echo $Derajat;?>
                    </option>
                    <?php 
							}
						?>
...
<div id="AnalisaAttribute" class="row"
        ...
        <div class="form-group row">
            ...
            <div class="input-group col-sm-5">
                <input type="text" class="form-control" id="NilaiSesuaiID" name="NilaiSesuai"
                    value="<?php if ($modul == 'ubah_analisa') { echo $DANilai;}?>" readonly>
    ...
    <div class="col-md-6">
        <div class="col-md-12 px-0">
            ...
            <div class="input-group col-sm-12 mb-2 px-0">
                <textarea class="form-control" rows="4" placeholder="" id="CatatanSebelumID" name="CatatanSebelum"
                    <?php if ($modul == 'ubah_analisa') { echo 'readonly';} else { echo 'required';} ?>><?php echo $DACatatanSebelum;?></textarea>
            </div>
        </div>
        <div class="col-md-12 mb-2 px-0">
            <div class="input-group">
                ...
                <input type="text" class="form-control" id="SebelumID" name="Sebelum" value="<?php echo $DASebelum;?>"
                    <?php if ($modul == 'ubah_analisa') { echo 'readonly';} else { echo 'required';} ?>>
            </div>
        </div>
    </div>
    <div class="col-md-6">
        <div class="col-md-12 px-0">
            ...
            <div class="input-group col-sm-12 px-0 mb-2">
                <textarea class="form-control" rows="4" placeholder="" id="CatatanSesudahID" name="CatatanSesudah"
                    <?php if ($modul == 'tambah_analisa') { echo 'readonly';} else { echo 'required';} ?>><?php echo $DACatatanSesudah;?></textarea>
            </div>
        </div>
        <div class="col-md-12 px-0">
            <div class="input-group">
                ...
                <input type="text" class="form-control" id="SesudahID" name="Sesudah" value="<?php echo $DASesudah;?>"
                    <?php if ($modul == 'tambah_analisa') { echo 'readonly';} else { echo 'required';} ?>>
            </div>
        </div>
    </div>
    <div class="col-md-12 text-center">
        <label class="form-check form-check-inline">
            <input class="form-check-input" type="radio" id="Status" name="Status" value="1"
                <?php if ($DAStatus == '1') { echo 'checked="checked"';}?>>
        ...
        <label class="form-check form-check-inline">
            <input class="form-check-input" type="radio" id="Status" name="Status" value="2"
                <?php if ($DAStatus == '2') { echo 'checked="checked"';}?>>
            <span class="form-check-label">
                Ditutup
            </span>
        </label>
...
$(document).ready(function() {
    ...
    //                 $("#SymbolID").append('<option value="' + id + '">' + name +
    //                     '</option>');
    //             }
    //         }
    //     })
    ...
    $('#batal').click(function() {
        ...
        $.ajax({
            ...
            success: function(hasil) {
                if (hasil == 'sukses_ubah_data' || hasil == 'sukses_ubah_data ' || hasil ==
                    'sukses_ubah_data	') {
    ...
    $("#myform").validate({
        ...
        submitHandler: function(form, event) {
            ...
            $.ajax({
                ...
                data: formData,
                success: function(hasil) {
                    if (hasil == 'sukses_ubah_data' || hasil == 'sukses_ubah_data ' ||
                        hasil == 'sukses_ubah_data	') {
                        location.href = "/index.php?page=analisa"
                    } else {
                        $('#modal-data').html(hasil);
                    }
