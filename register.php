...
<html lang="en">
	...
	<head>
		...
		<style>
			...
			:root {
			--Kontak-WA: #25D366; /* Warna WhatsApp */
			--Kontak-Tele: #0088CC; /* Warna Line */
			--Kontak-WA-uname: "6282237540250"; /* Nomor WhatsApp */
			--Kontak-WA-text: "Hallo admin,%20mohon%20aktivasi%20*username: *%20"; /* Pesan WhatsApp */
			--Kontak-Tele-uname: "KarismaTM"; /* Username Telegram */
			}
			#Kontak {text-align:center; width:100%; line-height:0px}
			#Kontak svg {width:24px;height:24px}
			#Kontak a {text-decoration:none}
			#Kontak .WA svg path {fill:var(--Kontak-WA)}
			#Kontak .Tele svg path {fill:var(--Kontak-Tele)}
			#Kontak .WA, #Kontak .Tele {display:inline-block; width:90px; text-align:center; margin:0 5px}
			#Kontak .onoffswitch {
			...
			#Kontak .onoffswitch-inner:before, .onoffswitch-inner:after {
			...
			border: 2px solid var(--Kontak-WA); border-radius: 20px;
			}
			#Kontak .WA .onoffswitch-inner:before {
			content: var(--Kontak-WA-uname);
			background-color: var(--Kontak-WA); color: #FFFFFF;
			font-size:11px;
			}
			...
			display: block; overflow: hidden;
			border: 2px solid var(--Kontak-Tele); border-radius: 20px;
			}
			#Kontak .Tele .onoffswitch-inner:before {
			content: var(--Kontak-Tele-uname);
			background-color: var(--Kontak-Tele); color: #FFFFFF;
			font-size:11px;
			}
								...
								<div class="card">
									<div class="card-body">
										<div class="col-12 text-center">
											...
											<p><strong>Untuk aktivasi bisa hubungi admin di Whatsapp / Telegram Berikut:</strong>
											</p>
										</div>
										<div id="Kontak">
											<div class="WA">
												<a href="javascript:void(0);" onclick="window.open('https://api.whatsapp.com/send?phone='+getComputedStyle(document.querySelector('#Kontak .WA .onoffswitch-inner'), ':before').getPropertyValue('content').replace('&quot;','').replace('&quot;','')+'&text='+getComputedStyle(document.querySelector('html'), ':root').getPropertyValue('--Kontak-WA-text').replace('&quot;','').replace('&quot;',''))" title="WhatsApp" target="_blank">
											...
											<div class="Tele">
												<a href="javascript:void(0);" onclick="window.open('https://telegram.me/'+getComputedStyle(document.querySelector('#Kontak .Tele .onoffswitch-inner'), ':before').getPropertyValue('content').replace('&quot;','').replace('&quot;',''))" title="Telegram" target="_blank">
